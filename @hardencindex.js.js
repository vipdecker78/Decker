...
.version-stamp {
  ...
  return (
    <>
      <Head>
        <title>Shinoa - API Documentation</title>
        <meta name="title" content="Shinoa - REST API Documentation" />
        <meta name="description" content="Shinoa is a free, simple REST API created by KyuuRzy for the common good. Feel free to use it, but please avoid DDoS attacks." />
        ...
        <meta property="og:title" content="Shinoa - REST API Documentation" />
        <meta property="og:description" content="Shinoa is a free, simple REST API created by KyuuRzy for the common good. Feel free to use it, but please avoid DDoS attacks." />
        <meta property="og:url" content="https://shinoa.us.kg" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://pomf2.lain.la/f/0u394d.jpg" />

        {/* Twitter Meta Tags */}
        <meta name="twitter:title" content="Shinoa - REST API Documentation" />
        <meta name="twitter:description" content="Shinoa is a free, simple REST API created by KyuuRzy for the common good. Feel free to use it, but please avoid DDoS attacks." />
        <meta name="twitter:image" content="https://pomf2.lain.la/f/0u394d.jpg" />
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebSite",
            "name": "Shinoa",
            "url": "https://shinoa.us.kg",
            "description": "Shinoa is a free, simple REST API created by KyuuRzy for the common good. Feel free to use it, but please avoid DDoS attacks.",
            "sameAs": [
